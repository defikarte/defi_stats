# Defi-Report Kanton Graubünden

Interaktiver Report zur Auswertung der Defibrillator-Daten im Kanton Graubünden, basierend auf OpenStreetMap-Daten via [defikarte.ch](https://defikarte.ch).

## 🎯 Über den Report

Der Graubünden-Report zeigt eine detaillierte Übersicht aller erfassten Defibrillatoren im Kanton Graubünden, aufgeschlüsselt nach Gemeinden.

### Hauptfunktionen

- **📊 Gemeindeübersicht**: Sortierbare Tabelle mit allen Gemeinden des Kantons Graubünden
...
- **Defibrillatoren total** im Kanton Graubünden
...
Der Report umfasst **87 Gemeinden** des Kantons Graubünden. GR hat 3 Amtssprachen (Deutsch, Rätoromanisch, Italienisch). Viele Gemeinden haben Doppelnamen (z.B. `Disentis/Mustér`, `Domat/Ems`, `Breil/Brigels`). Da `addr:city` in OSM selten gesetzt ist, übernimmt der GPS-Fallback die Zuordnung für ~99% der Defis.


## 🚀 Demo

Live unter [stats.defikarte.ch/reports/defi_report_gr.html](https://stats.defikarte.ch/reports/defi_report_gr.html)
...
```
https://cdn.jsdelivr.net/gh/OpenBracketsCH/defi_data@main/data/json/defis_kt_gr.geojson
```
...
# → http://localhost:8000/reports/defi_report_gr.html
```
...
|-------------|----------|
| Kantonsspital Graubünden / KSG | Chur |
| Spital Davos | Davos |
| Spital Engadin | Samedan |
