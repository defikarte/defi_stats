# Defi-Report Kanton Jura

Interaktiver Report zur Auswertung der Defibrillator-Daten im Kanton Jura, basierend auf OpenStreetMap-Daten via [defikarte.ch](https://defikarte.ch).

## 🎯 Über den Report

Der Jura-Report zeigt eine detaillierte Übersicht aller erfassten Defibrillatoren im Kanton Jura, aufgeschlüsselt nach Gemeinden.

### Hauptfunktionen

- **📊 Gemeindeübersicht**: Sortierbare Tabelle mit allen Gemeinden des Kantons Jura
...
- **Defibrillatoren total** im Kanton Jura
...
Der Report umfasst **57 Gemeinden** des Kantons Jura. Seit dem 1. Januar 2026 gehört **Moutier** zum Kanton Jura (Kantonswechsel von Bern). Fast alle Gemeinden sind mit `addr:city` in OSM erfasst — die Koordinaten stammen direkt aus den echten GeoJSON-Daten.


## 🚀 Demo

Live unter [stats.defikarte.ch/reports/defi_report_ju.html](https://stats.defikarte.ch/reports/defi_report_ju.html)
...
```
https://cdn.jsdelivr.net/gh/OpenBracketsCH/defi_data@main/data/json/defis_kt_ju.geojson
```
...
# → http://localhost:8000/reports/defi_report_ju.html
```
...
|-------------|----------|
| Hôpital du Jura / H-JU | Delémont |
| SBB CFF FFS | Delémont |
