# Defi-Report Kanton Tessin (Ticino)

Interaktiver Report zur Auswertung der Defibrillator-Daten im Kanton Tessin (Ticino), basierend auf OpenStreetMap-Daten via [defikarte.ch](https://defikarte.ch).

## 🎯 Über den Report

Der Tessin (Ticino)-Report zeigt eine detaillierte Übersicht aller erfassten Defibrillatoren im Kanton Tessin (Ticino), aufgeschlüsselt nach Gemeinden.

### Hauptfunktionen

- **📊 Gemeindeübersicht**: Sortierbare Tabelle mit allen Gemeinden des Kantons Tessin (Ticino)
...
- **Defibrillatoren total** im Kanton Tessin (Ticino)
...
Der Report umfasst **67 Gemeinden** des Kantons Tessin (Ticino). Der Kanton Tessin ist vollständig italienischsprachig. OSM-Einträge nutzen italienische Namen. Da `addr:city` selten gesetzt ist, übernimmt der GPS-Fallback die Zuordnung.


## 🚀 Demo

Live unter [stats.defikarte.ch/reports/defi_report_ti.html](https://stats.defikarte.ch/reports/defi_report_ti.html)
...
```
https://cdn.jsdelivr.net/gh/OpenBracketsCH/defi_data@main/data/json/defis_kt_ti.geojson
```
...
# → http://localhost:8000/reports/defi_report_ti.html
```
