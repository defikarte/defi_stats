# Defi-Report Kanton Glarus

Interaktiver Report zur Auswertung der Defibrillator-Daten im Kanton Glarus, basierend auf OpenStreetMap-Daten via [defikarte.ch](https://defikarte.ch).

## 🎯 Über den Report

Der Glarus-Report zeigt eine detaillierte Übersicht aller erfassten Defibrillatoren im Kanton Glarus, aufgeschlüsselt nach Gemeinden.

### Hauptfunktionen

- **📊 Gemeindeübersicht**: Sortierbare Tabelle mit allen Gemeinden des Kantons Glarus
...
- **Defibrillatoren total** im Kanton Glarus
...
Der Report umfasst **3 Gemeinden** des Kantons Glarus. Nach der Gemeindefusion von 2011 hat Glarus nur noch 3 Gemeinden.

| Gemeinde | Ortsteile / Bemerkung |
|----------|----------------------|
| Glarus | Hauptort |
| Glarus Nord | Näfels, Mollis, Niederurnen, Oberurnen u.a. |
| Glarus Süd | Schwanden, Linthal, Braunwald, Elm u.a. |

## 🚀 Demo

Live unter [stats.defikarte.ch/reports/defi_report_gl.html](https://stats.defikarte.ch/reports/defi_report_gl.html)
...
```
https://cdn.jsdelivr.net/gh/OpenBracketsCH/defi_data@main/data/json/defis_kt_gl.geojson
```
...
# → http://localhost:8000/reports/defi_report_gl.html
```
